...
function Cards() {
  ...
  return (
    <div className="lg:pb-8 pt-8 md:w-9/10 mx-auto overflow-hidden w-full shadow-2xl hover:shadow-lg">
      <div
        ref={scrollRef}
      ...
      <div className="bg-[#D7E7FB] shadow-2xl hover:shadow-[#064EA4] hover:shadow-lg transition-shadow duration-300">
